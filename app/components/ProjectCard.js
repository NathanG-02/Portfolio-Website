...
function ProjectCard( { title, description, binNum, linkToGitHub, linkToDeployment }, ref ){
    ...
    <div ref={ref} className={arvoRegular.className}>
        <div className='relative w-96 h-80 p-6 m-4 bg-black bg-opacity-50 opacity-80 rounded-2xl border-4 border-white/0 hover:border-white/80 hover:scale-105 transition-all duration-200'>
